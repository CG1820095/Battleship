...
#root.tk.call('wm', 'iconphoto', root._w, ImageTk.PhotoImage(Image.open(r"BattleshipGaming\images\icon.png")))
...
def login():
    ...
    root.destroy()
    subprocess.run(["python", (r"BattleshipGaming\second.py")])
...
#my_img = ImageTk.PhotoImage(Image.open (r"BattleshipGaming\images\battleship.jpg"))
